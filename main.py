...
# env
bot_token = os.environ.get("TOKEN", "6208316073:AAHenqVr3yBH1uDbfsYaIKyOyYsOnfoQYEQ") 
api_hash = os.environ.get("HASH", "de73d37c82992f907b59d9e606caa0ce") 
api_id = os.environ.get("ID", "26153887")
